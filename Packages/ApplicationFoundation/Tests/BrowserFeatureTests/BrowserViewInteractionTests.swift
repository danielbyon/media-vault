...
struct BrowserViewInteractionTests {
    ...
    @Test("Mounted Tab Overview scrolls vertically without selecting its mounted card")
    func mountedTabOverviewScrollsVerticallyWithoutSelectingCard() async throws {
