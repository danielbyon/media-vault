//
//  StoreKitEntitlementClientTests.swift
//  MediaVault
//
...
private actor FakeEntitlementStore: EntitlementStore {
    ...
    func purchase(product _: EntitlementStoreProduct) async throws -> EntitlementStorePurchaseResult {
        purchaseCallCount += 1
...
extension EntitlementStoreProduct {
    fileprivate static func nonConsumable(identifier: String) -> Self {
        Self(identifier: identifier, type: .nonConsumable)
    }

    fileprivate static func subscription(identifier: String) -> Self {
        Self(identifier: identifier, type: .other)
    }
}

extension EntitlementStoreTransaction {
    fileprivate static func active(productIdentifier: String) -> Self {
